...
# This is the line that makes htis file different
datDemog["N_S"] <- datDemog["N_S"]*2

# What will eventually be function arguments
of_stem <- "/mnt/windesk/projects/schisto/results/070326/H2_large"
villlevelp = "beta_SM"
ps_to_fit_names <- c(
                "beta_MS",
                "gamma_L",
