# copied to tab 1
#07/06/07 add new entry agegroup
...
#cdc$onsetday[cdc$onsettime ==5]<- 3
...
#Add entry for extracting the household number in 3 digits only, so not h07xxx but just xxx
hh$h_no <- substr(hh$q2_h_no,4,7)
