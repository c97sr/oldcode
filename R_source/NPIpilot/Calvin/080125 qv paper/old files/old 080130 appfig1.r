...
par(mar=c(4,4,1,4))
plot(0, type="n", axes=FALSE, xlim=c(0,11.5), ylim=c(2,10),xlab="", ylab="Viral load (copies/ml)",las=1)
axis(1, c(0,2,4,6,8,10), labels=rep("", 6))
...
mtext("<12hrs" ,side=1,at=2, line=1)
mtext("12-24hrs" ,side=1,at=4, line=1)
mtext("24-36hrs" ,side=1,at=6, line=1)
mtext("36-48hrs" ,side=1,at=8, line=1)
