...
mtext(dim(group0a)[1] ,side=1,at=2, line=4)
mtext(dim(group0b)[1] ,side=1,at=3.5, line=4)
mtext(dim(group2a)[1] ,side=1,at=6, line=4)
mtext(dim(group3a)[1] ,side=1,at=7.5, line=4)
mtext(dim(group2b)[1] ,side=1,at=10, line=4)
mtext(dim(group3b)[1],side=1,at=11.5, line=4)
