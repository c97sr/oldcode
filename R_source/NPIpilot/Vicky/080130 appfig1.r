...
group1b <- dat.a[dat.a$onsettime ==1 & dat.a$age <=15,]
group2b <- dat.a[dat.a$onsettime ==2 & dat.a$age <=15,]
group3b <- dat.a[dat.a$onsettime ==3 & dat.a$age <=15,]
group4b <- dat.a[dat.a$onsettime ==4 & dat.a$age <=15,]
group5b <- dat.a[dat.a$onsettime ==5 & dat.a$age <=15,]

group1a <- dat.a[dat.a$onsettime ==1 & dat.a$age >15,]
group2a <- dat.a[dat.a$onsettime ==2 & dat.a$age >15,]
group3a <- dat.a[dat.a$onsettime ==3 & dat.a$age >15,]
group4a <- dat.a[dat.a$onsettime ==4 & dat.a$age >15,]
group5a <- dat.a[dat.a$onsettime ==5 & dat.a$age >15,]


group1bb <- dat.b[dat.b$onsettime ==1 & dat.b$age <=15,]
group2bb <- dat.b[dat.b$onsettime ==2 & dat.b$age <=15,]
group3bb <- dat.b[dat.b$onsettime ==3 & dat.b$age <=15,]
group4bb <- dat.b[dat.b$onsettime ==4 & dat.b$age <=15,]
group5bb <- dat.b[dat.b$onsettime ==5 & dat.b$age <=15,]

group1ab <- dat.b[dat.b$onsettime ==1 & dat.b$age >15,]
group2ab <- dat.b[dat.b$onsettime ==2 & dat.b$age >15,]
group3ab <- dat.b[dat.b$onsettime ==3 & dat.b$age >15,]
group4ab <- dat.b[dat.b$onsettime ==4 & dat.b$age >15,]
group5ab <- dat.b[dat.b$onsettime ==5 & dat.b$age >15,]
...
##################################
#for median and IQR of each group#
mediangp <-vector(length=2)
lowiqrgp<-vector(length=2)
upiqrgp <-vector(length=2)
